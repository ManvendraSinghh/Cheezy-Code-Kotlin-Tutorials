...
fun dragObjects(objects:Array<Draggable1>){ //fun which accept an array of objects which are of type shape  now we cna replace shape with draggable here fun dragObjects(objects:Array<Shape>)
...
//interface Cloneable{   just an expample that we can implemebt multiple interface to class
//   fun clone()
//}

abstract  class Shape:Draggable1{     //abstract  class Shape:Draggable,Cloneable{
...
class Player(val name:String):Draggable1{
